    ...
    <div class="page-login--layer">
      <div
        ...
        <div
          ...
          <!-- logo -->
          <div class="page-login--logo login-title">SUPER ADMIN</div>
          <!-- form -->
                ...
                <el-form-item prop="code">
                  <el-input
                    ...
                    <template slot="append">
                      ...
                      <div class="login-code" v-html="formLogin.codeSvg" @click="getCodeSvg"></div>
                    </template>
                  </el-input>
                </el-form-item>
                <el-button
        ...
        <div class="page-login--content-footer">
          ...
          <p class="page-login--content-footer-copyright">
            ...
            <a href="https://gitee.com/Z568_568">
...
import {aes} from "@/libs/utils.crypto";
