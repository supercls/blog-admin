      ...
      <section class="data-list-box">
        ...
        <mk-el-table @sort="sortChange" :datas="datas" :key="updataKey" :height="130"
          ...
          <template v-for="field in fields" v-if="field.show">
            ...
            <el-table-column v-else-if="field.key=='isNewYear'" :align="field.align" :label="field.name"
                             :width="field.width" :fixed="field.fixed">
              <template slot-scope="scope">
                <el-tag type="success" v-if="scope.row.isNewYear">是</el-tag>
        ...
        <iframe :src="domi" style="border: none" :style="{height:tableHeight - 80 + 'px',width:'100%'}"></iframe>
      </section>
    </d2-container>
  </section>
</template>
  ...
  data() {
    return {
      ...
      fields: [
        ...
        {key: 'wallpaper', name: '站点背景', show: true, align: "center", enableSort: false, fixed: false},
        ...
        {key: 'isNewYear', name: '是否新年', show: true, align: "center", enableSort: false, fixed: false},
