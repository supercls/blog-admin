...
const frameIn = [
  {
    ...
    children: [
      ...
      {
        path: '/dir-website-message',
        name: 'dir-website-message',
        meta: {
          title: '留言管理',
          auth: true,
          perms: [
            'POST /api/private/websiteMessage/create',
            'POST /api/private/websiteMessage/list',
            'POST /api/private/websiteMessage/delete',
            'POST /api/private/websiteMessage/update',
          ],
        },
        component: _import('client/dir-website-message')
      },
      {
      ...
      {
        path: '/files/dir-files-info',
        name: 'dir-files-info',
        meta: {
          title: '我的资源',
          auth: true,
          perms: [
            'POST /api/private/files/create',
            'POST /api/private/files/list',
            'POST /api/private/files/delete',
            'POST /api/private/files/update',
            'POST /api/private/files/findOne',
          ],
        },
        component: _import('resources/files/dir-files-info')
      },
      {
